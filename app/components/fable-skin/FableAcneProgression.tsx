...
import type { SkinSceneHandle, ViewState } from "./SkinScene";
import LesionTimeline from "./LesionTimeline";
import ScaleBar from "./ScaleBar";
import { END_DAY, START_DAY } from "./lesion";

/**
 * The fable build of the acne-progression figure: a patch of cheek skin
 * under a dermatoscope with one lesion running its 21-day course, orbitable
 * and zoomable, scrubbed by the day timeline beneath it. This is the
 * acne-progression figure used in the whitepaper.
 *
 ...
 *
 * SkinScene imports three at module top, so it is loaded client-only and
 ...
 */
const SkinScene = dynamic(() => import("./SkinScene"), {
  ssr: false,
...
export default function FableAcneProgression() {
