...
import {checks as clipping} from './clipping.check';import {checks as integration} from './integration.check';import {checks as camera} from './camera.check';
export const ALL:Record<string,Check[]>={growth,warp,fx,engine,tracker,bones,airway,digestive,eyesTeeth,skin,systemic,clipping,integration,camera};
