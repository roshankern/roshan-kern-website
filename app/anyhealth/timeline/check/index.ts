...
import {checks as clipping} from './clipping.check';import {checks as integration} from './integration.check';
import {checks as director} from './director.check';import {checks as climax} from './climax.check';import {checks as camera} from './camera.check';import {checks as ghost} from './ghost.check';
export const ALL:Record<string,Check[]>={growth,warp,fx,engine,tracker,bones,airway,digestive,eyesTeeth,skin,systemic,clipping,integration,director,climax,camera,ghost};
