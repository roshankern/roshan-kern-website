...
import {checks as director} from './director.check';import {checks as climax} from './climax.check';
export const ALL:Record<string,Check[]>={growth,warp,fx,engine,tracker,bones,airway,digestive,eyesTeeth,skin,systemic,clipping,integration,director,climax};
