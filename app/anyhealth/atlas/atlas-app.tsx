...
export default function AtlasApp(){
 ...
 return <main className="studio">
  {atlas&&<AnatomyScene atlas={atlas} state={state} issues={ISSUES} selectedIssue={selectedIssue} onSelectIssue={setSelectedIssue} onProgress={n=>{setProgress(n);if(n===100)setError('');}} onError={setError}/>}
  ...
  {date&&<><BodyStats date={date} growth={GROWTH}/><TimelineBar issues={ISSUES} date={date} onDate={setDate} selected={selectedIssue} onSelect={setSelectedIssue}/></>}
